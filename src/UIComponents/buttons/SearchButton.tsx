...
const SearchButton: React.FC<SearchButtonProps> = ({ onClick, children, className, ...props }) => {
    return (
        <button
            type='button'
            onClick={onClick}
            ...
            style={{ maxWidth: '14.25rem', minWidth: '12.5rem' }} // Adjust maxWidth as needed
            {...props}
        >
            <span className="flex-1 text-left whitespace-nowrap overflow-hidden text-ellipsis">{children}</span>

            ...
            <div className="flex items-center justify-between flex-wrap">
                ...
                <nav className="flex-grow md:flex md:justify-center">
                    <ul className="flex gap-6 text-sm md:text-base">
                        <li className='flex cursor-pointer border-b-2 p-1  border-transparent hover:border-blue-600'> <Link href="/hotjobs">Jobs</Link></li>
                        <li className='flex cursor-pointer border-b-2 p-1 border-transparent hover:border-blue-600'>Skill Tests</li>
                        <li className='flex cursor-pointer border-b-2 p-1 border-transparent hover:border-blue-600'>Services</li>
                    </ul>
                </nav>
